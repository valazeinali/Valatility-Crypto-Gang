...
fig.add_trace(go.Scatter(x=btc.index, y=btc['Close'], mode='lines', name='ETH Close Price',line=dict(color='orange')))
...
fig.update_layout(
    title='ETH Daily Prices with Moving Averages and Pi Cycle Top Indicator',
...
fig.write_html("pi_top_eth.html")