...
def build_s2f(begin_timestamp, end_timestamp):
	...
	# fetch the metrics
	raw_data = requests.get(f'https://community-api.coinmetrics.io/v4/timeseries/asset-metrics?assets={asset}&metrics={metrics}&start_time={begin_timestamp}&end_time={end_timestamp}&frequency=1d&page_size=10000&pretty=true').json()
